...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        <Command className="**:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:font-medium **:[[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group-heading]:not([data-selected])]:text-muted-foreground">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
