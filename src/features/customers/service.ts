...
import {
  ...
  extensionForMime,
  sniffImageMime,
  type ImageMime as TxnImageMime,
} from "@/shared/core/image-data";
import {
...
/**
 * Image helpers (decodeTxnImage / sniffImageMime / extensionForMime) live in
 * `@/shared/core/image-data` — shared with the store logo upload path.
 */
